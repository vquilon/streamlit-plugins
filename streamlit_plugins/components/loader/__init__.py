...
@media only screen and (max-width: 600px) {
  section {
    ...
    .loader-7 .line1 {
        left: 0;
        -webkit-animation: line-grow 0.5s 0s ease alternate infinite;
        animation: line-grow 0.5s 0s ease alternate infinite;
    }

    .loader-7 .line2 {
        left: 20px;
        -webkit-animation: line-grow 0.5s 0.1s ease alternate infinite;
...
def book_loader(**kwargs):
    ...
    <style>
        ...
        .book-container .icon {
            ...
            color: var(--color);
            opacity: 0;
            -webkit-animation-name: container-icons;
            animation-name: container-icons;
        ...
        .book-container .book .book-inner .book-left:before,
        .book-container .book .book-inner .book-right:before {
            content: "";
            width: 48px;
            height: 4px;
            border-radius: 2px;
...
def get_loader(loader_lib: LoadersLib | Callable[..., Tuple[str, str ,str], ], **kwargs) -> Tuple[str, str, str]:
    loader_map = {
        ...
        LoadersLib.pulse_bars: pulse_bars,
        LoadersLib.pacman_loader: pacman_loader,
        LoadersLib.standard_loaders: standard_loaders,
        LoadersLib.showcase_pretty: showcase_pretty,
